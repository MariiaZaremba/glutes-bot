...
days = [
    {
        ...
        "text": (
            ...
            "Для того, щоб тренування приносили максимальну користь, тобі буде необхідно оцінити поставу через"
            "техніку виконання вправи Overhead Squat (Присідання з піднятими руками). "
            "За результатами цієї оцінки, ти дізнаєшся, як коригувати своє тренування, щоб воно задовольняло саме 
            "твоїм потребам та цілям.\n\n"
